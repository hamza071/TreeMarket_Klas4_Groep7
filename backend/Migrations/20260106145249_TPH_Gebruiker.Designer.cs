...
namespace backend.Migrations
{
    ...
    [Migration("20260106145249_TPH_Gebruiker")]
    partial class TPH_Gebruiker
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Klant", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Leverancier", b =>
                {
                    b.HasBaseType("backend.Models.Gebruiker");
            ...
            modelBuilder.Entity("backend.Models.Veilingsmeester", b =>
                {
                    b.HasBaseType("backend.Models.Gebruiker");
            ...
            modelBuilder.Entity("backend.Models.Bid", b =>
                {
                    b.HasOne("backend.Models.Klant", "Klant")
                        .WithMany()
                        .HasForeignKey("KlantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend.Models.Veiling", "Veiling")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Product", b =>
                {
                    b.HasOne("backend.Models.Leverancier", "Leverancier")
                        .WithMany("Producten")
            ...
            modelBuilder.Entity("backend.Models.Veiling", b =>
                {
                    ...
                    b.HasOne("backend.Models.Veilingsmeester", "Veilingsmeester")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.Klant", b =>
                {
                    b.HasOne("backend.Models.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("backend.Models.Klant", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("backend.Models.Leverancier", b =>
                {
                    b.HasOne("backend.Models.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("backend.Models.Leverancier", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("backend.Models.Veilingsmeester", b =>
                {
                    b.HasOne("backend.Models.Gebruiker", null)
                        .WithOne()
                        .HasForeignKey("backend.Models.Veilingsmeester", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
